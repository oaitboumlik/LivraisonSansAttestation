...
from src.utils import scaled_Laplacian, cheb_polynomial, get_adjacency_matrix
...
def get_backbones(config_filename, adj_filename, ctx):
    ...
    get_backbones_param(K, num_of_weeks, num_of_days, num_of_hours, num_of_vertices, adj_filename, ctx)


def get_backbones_param(K, num_of_weeks, num_of_days, num_of_hours, n_vertex, adj_file, ctx):
    adj_mx = get_adjacency_matrix(adj_file, n_vertex)
